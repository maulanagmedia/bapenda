...
public class DetailMerchantActivity extends AppCompatActivity implements
    ...
    private LocationCallback locationCallback = new LocationCallback(){
        ...
        public void onLocationResult(LocationResult location) {
            if (location == null) {
                Toast.makeText(DetailMerchantActivity.this,
...
//                LatLng ll = new LatLng(location.getLastLocation().getLatitude(), location.getLastLocation().getLongitude());
            ...
            if (mGoogleApiClient != null) {
                LocationServices.getFusedLocationProviderClient(DetailMerchantActivity.this).
    ...
    private void showDialogConfirm(final Bitmap bitmap_signature){
        confirm_dialog = DialogFactory.getInstance().
                createDialog(DetailMerchantActivity.this, R.layout.popup_confirm, 90);
                ...
                new ApiVolley.VolleyCallback() {
                    ...
                    public void onSuccess(String result) {
                        ...
                        try{
                            ...
                            if (status == 200){
                                Toast.makeText(DetailMerchantActivity.this, message, Toast.LENGTH_SHORT).show();
                                signature_dialog.dismiss();
//                                startActivity(new Intent(DetailMerchantActivity.this, MonitoringMerchantActivity.class));
                    ...
                    public void onError(String result) {
                        Toast.makeText(DetailMerchantActivity.this, R.string.error_message, Toast.LENGTH_SHORT).show();
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        LocationServices.getFusedLocationProviderClient(DetailMerchantActivity.this).requestLocationUpdates(mLocationRequest, locationCallback, Looper.myLooper());
        SettingsClient settingsClient = LocationServices.getSettingsClient(DetailMerchantActivity.this);
        ...
        settingsClient.checkLocationSettings(locationSettingsRequest).
                ...
                }).addOnFailureListener(DetailMerchantActivity.this, new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                ...
                if (e instanceof ResolvableApiException) {
                    ...
                    try {
                        ...
                        resolvable.startResolutionForResult(DetailMerchantActivity.this,
                                999);
