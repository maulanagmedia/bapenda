...
public class PetugasMonitoringActivity extends AppCompatActivity {
    ...
    private final String TAG = "PetugasMonitoring";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_petugas_monitoring);

        searchPetugas = findViewById(R.id.edt_search);
        rvJabatan = findViewById(R.id.rv_jabatan);
        listPetugas = findViewById(R.id.list_petugasMonitoring);
        ...
        listPetugas.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(PetugasMonitoringActivity.this, MerchantUntukMonitoring.class);
                Gson gson = new Gson();
    ...
    public void loadPetugas(String level, String keyword){
        ...
        try {
            ...
            Log.d("Petugas_log", "keyword: " + keyword);
        ...
        apiVolley = new ApiVolley(PetugasMonitoringActivity.this, body, "POST", URL.URL_DATA_PETUGAS, new ApiVolley.VolleyCallback() {
            @Override
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (status.equals("200")){
                        ...
                        adapter = new PetugasAdapter(PetugasMonitoringActivity.this, R.layout.list_petugas, petugasModels);
                        listPetugas.setAdapter(adapter);
                        Log.d(TAG, "onSuccess" + message);
                    } else {
                        petugasModels.clear();
                        adapter.notifyDataSetChanged();
                        Toast.makeText(PetugasMonitoringActivity.this, message, Toast.LENGTH_SHORT).show();
                        Log.d(TAG, "onSuccess" + message);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
            ...
            public void onError(String result) {
                ...
                Toast.makeText(PetugasMonitoringActivity.this, R.string.error_message, Toast.LENGTH_SHORT).show();
                AppLoadingScreen.getInstance().stopLoading();
            }
        });
    }
