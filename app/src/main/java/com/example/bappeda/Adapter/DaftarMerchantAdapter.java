...
public class DaftarMerchantAdapter extends ArrayAdapter<MerchantModel> {

    private Context mContext;

    public DaftarMerchantAdapter(Context context, int resource, List<MerchantModel> objects) {
